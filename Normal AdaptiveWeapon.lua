...
local master_switch = ui_new_checkbox("LUA", "A", "Enable YDL Adaptive Weapon")
...
local load_text = "[mishkat_adptv] Lua is loaded succsesfully"
local fail_text = "[mishkat_adptv] Not verified steam ID: "
