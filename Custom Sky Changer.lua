...
local enabled_reference = ui.new_checkbox("Lua", "A", "YuDi.Lua Sky Changer")
local color_reference = ui.new_color_picker("Lua", "A", "Override skybox", 255, 255, 255, 255)
local skybox_reference = ui.new_listbox("Lua", "A", "Override skybox name", skybox_names)
